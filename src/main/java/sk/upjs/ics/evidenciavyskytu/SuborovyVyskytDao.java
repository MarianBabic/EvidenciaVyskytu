...
public class SuborovyVyskytDao implements VyskytDao {
    ...
    public List<Vyskyt> dajVyskyty() {
        ...
        try (Scanner scanner = new Scanner(vyskytySubor)) {
...
//           vyskyty.add(new Vyskyt(scanner.nextLine()));
    ...
    public void vlozVyskyt(Vyskyt vyskyt) {
        ...
        try (FileWriter writer = new FileWriter(vyskytySubor, true);
    ...
    public void upravVyskyt(Vyskyt vyskyt) {
        List<Vyskyt> vyskyty = dajVyskyty();
        try (PrintWriter pw = new PrintWriter(vyskytySubor)) {
            for (Vyskyt v : vyskyty) {
                if (v.getId() == vyskyt.getId()) {
                    pw.println(vyskyt);
                } else {
                    pw.println(v);
                }
